...
/* WinDosDX: upstream spells this "../src/gui/render_scalers.h", which assumes
 * the autotools layout with src/ next to include/.  In the vendored tree gui/
 * is a sibling of include/. */
