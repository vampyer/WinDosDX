...
#include "setup.h"
#include "cpu.h"
/* WinDosDX: upstream spells this "../src/cpu/lazyflags.h", which assumes the
 * autotools layout with src/ next to hardware/.  In the vendored tree cpu/ is
 * a sibling of hardware/. */
