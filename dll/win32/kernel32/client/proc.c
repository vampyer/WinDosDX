                      ...
                      IN ULONG ImageMinorVersion)
{
        ...
        (ImageMajorVersion == 3 && ImageMinorVersion >= 10))
    {
        ...
        {
            DPRINT1("Accepting image version %lu.%lu, although WinDosDX is an NT %hu.%hu OS!\n",
                ImageMajorVersion,
                ImageMinorVersion,
...
BasepCheckWebBladeHashes(IN HANDLE FileHandle)
{
    ...
    {
        DPRINT1("Egad! This is a WinDosDX Compute Server and we should prevent you from using certain APIs...but we won't.");
    }
    else if (SharedUserData->SuiteMask & VER_SUITE_STORAGE_SERVER)
    {
        DPRINT1("Gasp! This is a WinDosDX Storage Server and we should prevent you from using certain APIs...but we won't.");
    }
    else if (SharedUserData->SuiteMask & VER_SUITE_BLADE)
    {
        DPRINT1("Golly! This is a WinDosDX Web Blade Server and we should prevent you from using certain APIs...but we won't.");
    }
